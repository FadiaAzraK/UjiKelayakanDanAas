...
<html lang="en">
    ...
    <body>
        ...
        <div>
            ...
            <a href="{{ route('rekap.download', $student->id) }}" class="btn-print">Cetak (.pdf)</a>
            {{-- {{dd($student->id)}} --}}
            {{-- @endforeach --}}
    ...
    <div class="container">
        ...
        <div class="description">
            <p>Dengan ini menyatakan saya telah melakukan pelanggaran tata tertib sekolah,
                yaitu terlambat datang ke sekolah sebanyak <b>{{ $student->late_count}} kali</b> yang mana hal tersebut termasuk
